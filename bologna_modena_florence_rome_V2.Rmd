...
modena$Humidity.1 <- c(rep(NA, 5), modena$Humidity[(1):(nrow(modena)-5)])
#push npi back num_lag days
...
florence$Humidity.1 <- c(rep(NA, 5), florence$Humidity[(1):(nrow(florence)-5)])
#push npi back num_lag days
...
rome$Humidity.1 <- c(rep(NA, 5), rome$Humidity[(1):(nrow(rome)-5)])
#push npi back num_lag days
