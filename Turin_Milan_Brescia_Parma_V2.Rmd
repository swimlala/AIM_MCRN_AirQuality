...
Like in the turin etc. V2, here, we use NPIs, humidity, and temp in the GAMs. Climate variables are lagged n = climate_lag days. NPI is lagged from n = 0 to num_iter days.
